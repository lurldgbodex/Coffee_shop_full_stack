...
AUTH0_DOMAIN = 'lurldgbodex.us.auth0.com'
ALGORITHMS = ['RS256']
...
def get_token_auth_header():
    ...
    if len(bearer_token) == 1 or len(bearer_token) > 2:
        raise AuthError
...
def verify_decode_jwt(token):
    url_path = urlopen(f"https://{AUTH0_DOMAIN}/.well-known/jwks.json")

    jwk = json.loads(url_path.read())
